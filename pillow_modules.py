...
image.rotate(180).save("kuş3.jpg") #180 derece çeviriyor resmi 


image.rotate(90).save("kuş4.jpg") #90 derece döndürülüyor resim 

image.convert(mode = "L").save("kuş5.jpg") #resimi siyah beyaza çeviriyor
 

degistir = (960,600) #çevireceğimiz resmin boyutlarını belirliyoruz. 

image.thumbnail(degistir) #verdiğimiz değeri bu fonksiyona yazarak resimin boyutlarını değiştiriyoruz
